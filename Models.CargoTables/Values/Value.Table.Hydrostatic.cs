...
public class ValueTableHydrostatic
{
    ...
    public ValueTableHydrostatic(double disp, double draft, double tpc, double KM, double LCF, double mctc, double lCB,
        double cM)
    {
        Displacement = disp;
        Draft = draft;
    ...
    {
        return Displacement + "\t" + Draft + "\t" + TPC + "\t" + MetacentrKM + "\t" + FloatationCenterLCF + "\t" +
               MCTC + "\t" + LCB + "\t" + CM;
    }
